...
支持查询、添加、删除东方财富自选股
统一输出到 ~/.openclaw/data/output/miaoxiang/（可用 MIAOXIANG_OUTPUT_DIR 覆盖）
"""
...
def main():
    ...
    parser.add_argument("--output-dir", dest="output_dir", help=f"输出目录，默认 {default_miaoxiang_output_dir()}")
    
    args = parser.parse_args()
    
    default_output = default_miaoxiang_output_dir()
